-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('PENDING', 'SCHEDULED', 'COMPLETED', 'SKIPPED', 'POSTPONED', 'CANCELED');

-- CreateEnum
CREATE TYPE "TaskPriority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'URGENT');

-- CreateEnum
CREATE TYPE "TaskSource" AS ENUM ('EMAIL', 'MANUAL', 'API');

-- CreateEnum
CREATE TYPE "TaskEventType" AS ENUM ('CREATED', 'SCHEDULED', 'COMPLETED', 'POSTPONED', 'SKIPPED', 'RESCHEDULED', 'CANCELED');
...
CREATE TABLE "User" (
    ...
    "workdayStartMin" INTEGER DEFAULT 540,
    "workdayEndMin" INTEGER DEFAULT 1080,
...
-- CreateIndex
CREATE INDEX "Task_userId_scheduledStart_idx" ON "Task"("userId", "scheduledStart");
